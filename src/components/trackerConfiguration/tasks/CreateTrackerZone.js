...
class CreateTrackerZone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            activePage: 1,
    ...
    render() {
        console.log('EditCreateTrackerConfiguration  ==== ', this.state.markers, this.state.radius);
...
CreateTrackerZone = reduxForm({
    // a unique name for the form
    form: 'createTrackerForm',
    enableReinitialize: false,
    Field,
    validate,
})(CreateTrackerZone);

export default connect(null, { setTrackerArea })(CreateTrackerZone);
