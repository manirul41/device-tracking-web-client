...
class EditDangerTrackerZone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isRedirect: false,
    ...
    componentDidMount() {
        ...
        request.then(
            response => {
                ...
                const latlng = JSON.parse(this.props.SingleDangerTrackerArea.TargetArea.coordinates);
                const name = this.props.SingleDangerTrackerArea.TargetArea.name;
                const radius = this.props.SingleDangerTrackerArea.TargetArea.radius;
                const startTime = this.props.SingleDangerTrackerArea.TargetArea.startTime;
                const endTime = this.props.SingleDangerTrackerArea.TargetArea.endTime;
                let days = JSON.parse(this.props.SingleDangerTrackerArea.TargetArea.days);
    ...
    render() {
        ...
        if (this.state.isRedirect) {
            return (<Redirect to={`/danger-zone/${this.props.match.params.id}`} />);
        }
...
function mapStateToProps(state) {
  ...
  return {
    SingleDangerTrackerArea: state.tracker
  };
}
...
EditDangerTrackerZone = reduxForm({
    // a unique name for the form
    form: 'editDangerTrackerForm',
    enableReinitialize: false,
    Field,
    validate,
})(EditDangerTrackerZone);

export default connect(mapStateToProps, { getSingleTargetTrackerArea, updateTrackerArea })(EditDangerTrackerZone);
