...
class TrackerSelection extends Component {
    constructor(props) {
        super(props);
        this.state = {
            TrackerData: [],
    ...
    handleExport() {
        //------------single page pdf creation working---------
        html2canvas(document.getElementById('toPdf')).then((canvas) => {
            let hgt = 0;
            let wid = 0;
            const img = canvas.toDataURL('image/png', wid = canvas.width, hgt = canvas.height);
        ...
        //------------developing for multiple page pdf creation-----
        // console.log('from-----handleExport----');
        //     html2canvas(document.getElementById('toPdf')).then((canvas) => {
        //     let hgt = 0;
        //     let wid = 0;
        //     //const img = canvas.toDataURL('image/png', wid = canvas.width, hgt = canvas.height);
        ...
        //     const width = doc.internal.pageSize.width; 
        //     const height = width * hratio;
        //     console.log('hratio, hight ,width ,hgt ,wid:  ', hratio, height, width, hgt, wid);
        //     const pageNumber = Math.ceil(hgt / height);
        //     for (let i = 0; i < pageNumber; i++) {
        //       const srcImg = canvas;
        //       const sX = 0;
        //       const sY = height * i; // start 980 pixels down for every new page
        //       const sWidth = width;
        ...
        //       console.log('Adding multiple page');
        ...
        //       const canvasDataURL = onePageCanvas.toDataURL('image/png', width, height);

        //       if (i > 0) doc.addPage(width, height);
        //       doc.setPage(i + 1);
        //       doc.addImage(canvasDataURL, 'PNG', 20, 20, width, height);
        //     }
        //     // doc.addImage(img, 'PNG', 20, 20, width, height);
        //     doc.save('Test.pdf');
        // });
        ...
        //------------pdf creation working without style--------
        // const doc = new jsPDF();
        // const elementHandler = {
        //   '#capture': function (element, renderer) {
        //     return true;
        //   }
        // };
    ...
    render() {
        ...
        return (
            <div id="toPdf">
                <div className="container mt-4" id="capture">
...
export default connect(mapStateToProps, {getUserTrackers})(TrackerSelection);
